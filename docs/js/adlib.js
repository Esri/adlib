/**
* adlib - v1.0.1 - Thu Nov 30 2017 10:41:42 GMT-0700 (MST)
...
function arborist (object, propertyPath) {
  ...
  } if(object && isObject$3(object) ) {

    return pruneObject(lodash_mapvalues(object, iteratee));
...
function _swap(parameter, settings, transforms) {
    ...
    if (transformCheck.length > 1) {
      ...
      value = lodash_get(settings, parameter);
    }
    return value;
}
