...
const adlib = require("../dist/adlib");


describe('adlib TypeScript ::', () => {
  it('should return a deep copy of the template', () => {
    ...
    result.check = 'wat';
    expect((template as any).check).to.be.undefined;
  ...
  describe('arrays ::', () => {
    ...
    it('should replace tokens with an array and run transforms', () => {
      ...
      let transforms = {
        upcaseArr (key:string, val:any, settings:any) {
    ...
    it('should run passed in transforms', () => {
      ...
      let transforms = {
        upcase (key:string, val:any, settings:any) {
